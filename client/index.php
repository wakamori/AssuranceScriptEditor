	...
	<div id="menu-color" class="menu-box">
		<form action="#" method="post">
			...
			<select id="theme-option">
				<option value="eeeeee,dddddd,cccccc,bbbbbb,aaaaaa,999999,888888">Default</option>
